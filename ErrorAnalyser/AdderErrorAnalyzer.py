...
def HEAA(tot_num_bits, inaccurate_bits):
    ...
    if tot_num_bits <= 10:
        ...
        return (HEAA_estimate_AE, HEAA_estimate_MAE, HEAA_estimate_RMSE)
...
def HOERAA(tot_num_bits, inaccurate_bits):
    ...
    if tot_num_bits <= 10:
        ...
        return (HOERAA_estimate_AE, HOERAA_estimate_MAE, HOERAA_estimate_RMSE)
...
def HOAANED(tot_num_bits, inaccurate_bits):
    ...
    if tot_num_bits <= 10:
        ...
        return (HOAANED_estimate_AE, HOAANED_estimate_MAE, HOAANED_estimate_RMSE)
...
def M_HERLOA(tot_num_bits, inaccurate_bits):
    ...
    if tot_num_bits <= 10:
        ...
        return (M_HERLOA_estimate_AE, M_HERLOA_estimate_MAE, M_HERLOA_estimate_RMSE)
